...
<script>
    ...
    <div class="checkout-sidebar">
        ...
        <div class="profile-image-container">
            <img src="karyawan.jpeg" alt="Profil Karyawan">
        </div>
                ...
                <td>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-details">
                                ...
                                <p class="product-price">Rp<?= number_format($hargaproduk) ?></p>
                                ...
                                <form action="editqnty.php" method="post">
                                    <div class="kuantitas">
                                    <button type="button" class="btnn btn-minus" onclick="handleCounterMin(this)">-</button>
                                    <input type="number" name="quantity[<?= $kodeProduk ?>]" class="counter" value="<?= $show['Kuantitas_Produk'] ?>" min="0" max="<?= $max ?>">
                                    <button type="button" class="btnn btn-plus" onclick="handleCounterPlus(this)">+</button>
                                ...
                                <?php
                                    ...
                                    <p class="product-quantity">x<?= $show['Kuantitas_Produk'] ?>
                                    <button class="editqnty" onclick="window.location.href='dashboard(2).php?edit=1&kodeqnty=<?= $kodeProduk ?>'">Edit</button>
                                    </p>
                                <?php
                                } ?>
