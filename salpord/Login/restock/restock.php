...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['edit'])) {
        $sql = "UPDATE produk SET Nama_Produk='$nama_produk', Brand_Produk='$brand_produk', Harga_Produk='$harga_produk', Jumlah_Produk='$jumlah_produk' WHERE Kode_Produk='$kode_produk'";
        ...
        $sql = "INSERT INTO produk (Kode_Produk, Nama_Produk, Brand_Produk, Harga_Produk, Jumlah_Produk, Gambar) VALUES ('$kode_produk', '$nama_produk', '$brand_produk', '$harga_produk', '$jumlah_produk')";
        if ($koneksi->query($sql) === TRUE) {
            header("Location: " . $_SERVER['PHP_SELF']);
            exit();
        } else {
