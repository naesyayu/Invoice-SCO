...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 06:51 AM
...
CREATE TABLE `pelanggan` (
  ...
  `No_Hp_Pelanggan` int(16) DEFAULT NULL,
...
INSERT INTO `produk` (`no`, `Kode_Produk`, `Nama_Produk`, `Brand_Produk`, `Harga_Produk`, `Jumlah_Produk`) VALUES
(1, 'J05', 'Kaos', 'Adios', 90000, 11),
(2, 'J55', 'Jaket', 'Nike', 150000, 8),
(3, '3', 'Sandal', 'Homiepad', 25000, 20),
(4, '4', 'Kaos Kerah', 'Polo', 80000, 20),
(5, '5', 'Sepatu', 'Aerostreet', 160000, 25),
(6, '6', 'Kaos', 'Cardinal', 100000, 40),
(7, '7', 'Jaket', 'Reebok', 200000, 15),
(8, '8', 'Kaos Polo', 'Uniqlo', 120000, 35);
...
ALTER TABLE `produk`
  ...
  ADD UNIQUE KEY `Kode_Produk` (`Kode_Produk`) USING BTREE;
...
ALTER TABLE `detail_transaksi`
  ...
  ADD CONSTRAINT `detail_transaksi_ibfk_3` FOREIGN KEY (`Kode_Produk`) REFERENCES `produk` (`Kode_Produk`) ON DELETE CASCADE ON UPDATE CASCADE;
