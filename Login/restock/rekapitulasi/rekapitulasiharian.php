...
<body>
    ...
    ?>
        <tr>
            <td><?= $date ?></td>
            <td style="width: 100px;"><button onclick="window.location.href='../riwayati invoice admin/riwayatinvadmin.php?tahun=<?= $tahun ?>&bulan=<?= $bulan ?>&tanggal=<?= $tanggal ?>'">Lihat</button></td>
